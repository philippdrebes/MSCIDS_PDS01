...
my_list03 = [i for i in map(lambda x: x * x, nums)]
print("my_list03: ", my_list03)
...
my_list05 = [i for i in nums if i % 2 == 0]
print("my_list05: ", my_list05)
...
my_list07 = [(s, i) for s in str01 for i in ran01]
print("my_list07: ", my_list07)
