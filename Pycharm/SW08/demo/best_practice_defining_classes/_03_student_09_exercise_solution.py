# _03_student_09_exercise_solution.py
...
# Ninth part of step 3:        #### Solution of Exercise  ####
...
class Student:
    def __init__(self, first_name, last_name):
        self.first_name = first_name               # calls method first_name.setter !!!
        #Student.first_name = first_name            # for trial only: first_name is a class-variable
        self.last_name = last_name
        #Student.last_name = last_name              # for trial only: first_name is a class-variable
                                                    # troubles with our fist business rule!!! don't do it!
